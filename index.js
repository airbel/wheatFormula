...
var waterCalculation = document.getElementById("waterCalculation"); //配方水量
...
var restart = 0;
    ...
    getresult.addEventListener("click", function () {
        ...
        tempdata[6] = waterCalculation.value;
        ...
        used.innerHTML += '<br>******<br>適用水溫:'+((Number(tempdata[4])*3)-(Number(tempdata[0])+Number(tempdata[2])+Number(tempdata[3])));
        used.innerHTML += '<br>******<br>冰量:'+((Number(tempdata[6])*3)*(Number(tempdata[0])+Number(tempdata[2])+Number(tempdata[3])));
        return false;
    })
